...
#define DRINK_CONFIRM_MS 400  // Re-read weight after this delay before declaring proactive drink (reduces false triggers from noise)

// --- Status Colors (RGB IDs) ---
// 0=Off, 1=Red, 2=Green, 3=Blue, 4=White, 5=Orange, 8=Purple
#define COLOR_ALERT 1  // Red
#define COLOR_OK 2     // Green (Drink confirmed)
#define COLOR_REFILL 3 // Blue (Refill confirmed)
#define COLOR_IDLE 8   // Purple (System Active/Day)
